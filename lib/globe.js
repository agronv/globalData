...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // function makeCorsRequest() {
        let url = 'https://atlas.media.mit.edu/hs92/export/2010/usa/all/show/';
        
        // const appid = "385bcbb4deefa139257c79193e92438d"
        fetch(url)
    ...
    //     xhr.setRequestHeader('Access-Control-Allow-Meth0ds', 'POST,GET,PUT,DELETE');        
    //     xhr.send();
    // }
