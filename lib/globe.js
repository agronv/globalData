...
import {countries, countries2 } from './countries';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Object.keys(countries2).forEach((countryName) => {
        countryLi = document.createElement('option');
        countryLi.value = countryName;
    ...
    Object.keys(products).forEach((productName) => {
        productLi = document.createElement('option');
        productLi.value = productName;
    ...
    countryInput.addEventListener("change", (e) => {
        e.preventDefault();
        currentCountry = countries2[e.target.value];
        fetchData();
    });
