...
import countries2 from './countries2.js';
import products from './filtered.js'; 
import filtered from './filtered2.js'; 
import listy from './all_products.js'; 
...
export default class Inputs {
  ...
  fetchData() {
    ...
    // const exports = "https://api.wto.org/timeseries/v1/data?i=HS_M_0010&r=all&p=840&ps=2018&pc=270900&mode=codes"
    // const exports = "https://api.wto.org/timeseries/v1/data?i=HS_M_0010&r=all&p={this.countryCode}&ps={this.year}&pc={this.productcode}&mode=codes"
    // const imports = "https://api.wto.org/timeseries/v1/data?i=HS_M_0010&r=840&p=default&ps=2018&pc=270900&mode=codes"
    // const imports = "https://api.wto.org/timeseries/v1/data?i=HS_M_0010&r={this.country}&p=default&ps={this.year}&pc={this.productcode}&mode=codes"
